...
/*
    //mode01の時これを作成・中身を変更する
    if(f.mode=='01'){
    push(1,3,10,1,2);//内階段へ繋げる
    push(6,1,8,4,2)
    };
    */
...
; *131012
; [iscript ]
; tf.mpnm='f201_39_13_ant'
; if(f.mode='01')tf.mpnm='f201_39_13_ant';
; [endscript ]
; [jump target="*confirm" ]
